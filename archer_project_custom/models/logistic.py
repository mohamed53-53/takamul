...
class LogisticRequest(models.Model):
    ...
    def create(self, vals_list):
        vals_list['sequence'] = self.env['ir.sequence'].next_by_code('archer_project_custom.logistic_seq') or '/'
        res = super(LogisticRequest, self).create(vals_list)
        return res
