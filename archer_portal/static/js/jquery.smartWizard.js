...
(function (factory) {
  ...
  var defaults = {
    ...
    style: {
      ...
      btnNextIconCss: 'sb-icon',
      btnPrevCss: 'sw-btn-prev',
      btnPrevIconCss: 'pb-icon',
  ...
  var SmartWizard = /*#__PURE__*/function () {
    ...
    _createClass(SmartWizard, [{
      ...
      value: function _createToolbar(position) {
        ...
        var btnNextIcon = this.options.toolbar.showNextButton !== false ? $('<i></i>').addClass('fa fa-chevron-right ' + this.options.style.btnNextIconCss): null;
        ...
        var btnPrevIcon = this.options.toolbar.showPreviousButton !== false ? $('<i></i>').addClass('fa fa-chevron-left ' + this.options.style.btnPrevIconCss): null;
        return toolbar.append(btnPrevious, btnPrevIcon, btnNext, btnNextIcon, this.options.toolbar.extraHtml);
      }
    }, {
      key: "_navigate",
      ...
      value: function _setButtons(idx) {
        ...
        this.main.find('.' + this.options.style.btnNextCss +
                       ', .' + this.options.style.btnPrevCss +
                       ', .' + this.options.style.btnNextIconCss +
                       ', .' + this.options.style.btnPrevIconCss).removeClass(this.options.style.anchorDisabledCss);

        var p = this._getStepPosition(idx);

        if (p === 'first' || p === 'last') {
          var c = p === 'first' ? '.' + this.options.style.btnPrevCss : '.' + this.options.style.btnNextCss;
          var i = p === 'first' ? '.' + this.options.style.btnPrevIconCss : '.' + this.options.style.btnNextIconCss;
          this.main.find(c+', '+i).addClass(this.options.style.anchorDisabledCss);
        } else {
          if (this._getShowable(idx, 'next') === null) {
            ...
            this.main.find('.' + this.options.style.btnNextIconCss).addClass(this.options.style.anchorDisabledCss);
          }
          ...
          if (this._getShowable(idx, 'prev') === null) {
            ...
            this.main.find('.' + this.options.style.btnPrevIconCss).addClass(this.options.style.anchorDisabledCss);
          }
        }
      }
    }, {
